...
const currentDataSchema = new mongoose.Schema({
    ...
    data: { type: mongoose.Schema.Types.Mixed, required: true }, // { COD: 15.2, pH: 7.1, ... }
    rawData: { type: mongoose.Schema.Types.Mixed }, // Dữ liệu gốc từ API
...
const timeseriesBucketSchema = new mongoose.Schema({
    ...
    stats: {
        parameters: { type: mongoose.Schema.Types.Mixed } // Pre-calculated stats
    }
}, {
